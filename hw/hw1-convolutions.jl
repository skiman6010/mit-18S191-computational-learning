...
function matrix_to_vecvec(matrix)
	...
	return [x for x in eachcol(matrix)]
end
...
The image is unrecognisable with intensity ~2, with higher intensities the noise overhwlems the pixels in the image.
"""
...
# ╔═╡ 1569f28c-f32c-11ea-3474-97ca5bdc4da1
